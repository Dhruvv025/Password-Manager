...
function Manager() {
  ...
  return (
    <>
      ...
      {/* Same as */}
      <ToastContainer />
      <div class="absolute top-0 z-[-2] h-screen w-screen rotate-180 transform  bg-blue-100"></div>
      ...
      <div className="myContainer px-80 text-center">
        ...
        <div className=" flex flex-col p-4 gap-8 items-center">
          ...
          <button
            type="submit"
            className=" bg-blue-300 px-8 py-3 w-fit  flex justify-center items-center rounded-full hover:bg-blue-500 "
